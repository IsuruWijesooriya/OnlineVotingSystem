...
<div class="containe-fluid">
    ...
    $votes  = $conn->query("SELECT voting_opt_id FROM votes where voting_id = $id GROUP BY voting_opt_id HAVING COUNT(voting_opt_id) >1 ");
    $v_arr = array();
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                    <div class="text-center">
                                        <h1><b><?php echo $row['category'] ?></b></h1>
                                        <h3><b>--- The Result is ---</b></h3>
                                    </div>
                            </div>
                        </div>
                        <?php if ($opt_arr[$row['id']]>1){ ?>
                        <div class="row mt-3">
                        ...
                        ?>
                            <div class="candidate" style="position: relative;">
                                ...
                                <div class="vote-field">
                                    <span class="badge badge-success"><large><b><?php echo isset($v_arr[$candidate['id']]) ? "Winner" : "Loser" ?></b></large></span>
                                </div>
                            </div>
                        <?php } ?> 
                        </div>
